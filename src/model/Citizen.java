...
public class Citizen {
  ...
  public String toString() {
    return "[Detail for " + firstName + " " + " birthCertificateNo = " + birthCertificateNo + "  First Name = " + firstName + " | Last Name = " + lastName + " | National ID = " + nationalId + " | Location = " + location + " | Ward = " + ward
